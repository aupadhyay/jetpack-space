...
--Game Elements
    ...
    leftWall = display.newImageRect("Icon-76.png",45,_H)--insert proper image
    leftWall.anchorX = 0.5
    leftWall.anchorY = 0.5
    leftWall.x = 22
    leftWall.y = _H/2

    rightWall = display.newImageRect("Icon-76.png",45,_H)--insert proper image
    ...
    scoreText = display.newText("Score:",_W/2-60,20,native.systemFont, 30)--insert proper font
    --scoreText:setFillColor(255/255,124/255,46/255)
    
    scoreNumText = display.newText("scoreNum",260,30,native.systemFont, 36)--insert proper font and scorenum
