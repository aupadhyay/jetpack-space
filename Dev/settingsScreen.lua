...
function settingsScreen:enterScene(e)
	...
	settingsGroup:insert(unmute)
        unmute:setFillColor( 0.72, 0.9, 0.16, 0.78 )
	...
	if (muteIsGreen) then
             mute:setFillColor( 0.72, 0.9, 0.16, 0.78 )
             unmute:setFillColor( 1, 1, 1, 1 )
         elseif (unmuteIsGreen) then
              unmute:setFillColor( 0.72, 0.9, 0.16, 0.78 )
              mute:setFillColor( 1, 1, 1, 1 )
         end
...
function addHelpScreen(e)
	...
	options  = {
		text = "Tilt your device left or right to guide Commander Comet through the asteroid belt as he passes between obstacles.",
		x = _W/2,
		y = _H/2,
		font = "Game Over",
		fontSize = 65,
